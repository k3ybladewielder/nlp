...
# Summary
1. [**Intro and Evolution of NLP**](#intro-and-evolution-of-nlp)
2. [**Natural Language Understanding**](#natural-language-understanding)
   - 2.1. [Contextual Word Representation](#contextual-word-representation)
   - 2.2. [Transformer](#transformer)
   - 2.3. [Positional Encoding](#positional-encoding)
   - 2.4. [GPT (Generative Pre-trained Transformer)](#gpt-generative-pre-trained-transformer)
   - 2.5. [BERT (Bidirectional Encoder Representations from Transformers)](#bert-bidirectional-encoder-representations-from-transformers)
   - 2.6. [RoBERTa](#roberta)
   - 2.7. [ELECTRA](#electra)
...
4. [**In-context Learning**](#in-context-learning)
   ...
   - 4.2. [Current Movement](#current-movement)
   - 4.3. [Techniques and Suggested Methods](#techniques-and-suggested-methods)
5. [**Behavioral Evaluation of NLU Models**](#behavioral-evaluation-of-nlu-models)
   - 5.1. [Analytical Considerations](#analytical-considerations)
   - 5.2. [Compositionality](#compositionality)
   - 5.3. [COGS and ReCOGS](#cogs-and-recogs)
   - 5.4. [Adversarial Testing](#adversarial-testing)
   - 5.5. [Adversarial NLI](#adversarial-nli)
   - 5.6. [Dynasent](#dynasent)
6. [**Analysis Methods**](#analysis-methods)
   - 6.1. [Probing](#probing)
   - 6.2. [Feature Attribution](#feature-attribution)
   - 6.3. [Causal Abstraction & Interchange Intervention Training (IIT)](#causal-abstraction--interchange-intervention-training-iit)
   - 6.4. [Distributed Alignment Search (DAS)](#distributed-alignment-search-das)
7. [**Methods and Metrics**](#methods-and-metrics)
   - 7.1. [Classifier Metrics](#classifier-metrics)
   - 7.2. [Generation Metrics](#generation-metrics)
   - 7.3. [Datasets](#datasets)
   - 7.4. [Data Organization](#data-organization)
   - 7.5. [Model Evaluation](#model-evaluation)
8. [**Fantastic Language Models and How to Build Them**](#fantastic-language-models-and-how-to-build-them)
